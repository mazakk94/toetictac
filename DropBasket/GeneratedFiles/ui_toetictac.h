...
public:
    ...
    void setupUi(QMainWindow *ToetictacClass)
    {
        ...
        label_9->setGeometry(QRect(260, 80, 81, 20));
        numOfClients = new QLabel(centralWidget);
        numOfClients->setObjectName(QStringLiteral("numOfClients"));
        numOfClients->setGeometry(QRect(260, 100, 47, 13));
    ...
    void retranslateUi(QMainWindow *ToetictacClass)
    {
        ...
        label_9->setText(QApplication::translate("ToetictacClass", "ilosc klient\303\263w", 0));
        numOfClients->setText(QApplication::translate("ToetictacClass", "0", 0));
    } // retranslateUi
